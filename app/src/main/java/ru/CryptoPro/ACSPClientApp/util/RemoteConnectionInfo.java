...
public final class RemoteConnectionInfo {
     ...
     */
    public void print() {
        Logger.log("Remote host: " + getHostAddress() + ":" + getHostPort() +
            "\nPage: " + getHostPage() +
    ...
    public static final RemoteConnectionInfo jessica =
        new RemoteConnectionInfo("auth-jessica.devoffice.ru",
            DEFAULT_PORT, "config", false);

    public static final RemoteConnectionInfo test =
        new RemoteConnectionInfo("cpca.cryptopro.ru",
            DEFAULT_PORT, "", false);
