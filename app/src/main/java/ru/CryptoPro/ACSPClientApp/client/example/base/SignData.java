...
import ru.CryptoPro.ACSPClientApp.client.example.interfaces.HashData;
...
import ru.CryptoPro.ACSPClientApp.util.Containers;
import ru.CryptoPro.ACSPClientApp.util.Logger;
import ru.CryptoPro.ACSPClientApp.util.ProgressDialogHolder;
...
public abstract class SignData implements HashData, Containers {
    ...
    public void load(boolean askPinInWindow, String storeType,
        ...
        Logger.log("Read certificate:" + certificate.getSubjectDN() +
